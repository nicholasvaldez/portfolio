...
function Skills({ skills }: Props) {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 overflow-y-scroll scrollbar sm:scrollbar-track-transparent mt-20 w-30 h-[60%] scrollbar-thumb-[#F6D0B1]/80">
